...
print("The Destroyer's position is: \(destroyer.position)")
destroyer.moveRight()
print("The Destroyer's position is: \(destroyer.position)")
...
//print(falcon.weapon)
print("The above statement does not work because the variable `falcon` defined in the other file is no longer in the scope of this file. This means the compiler does not know any `falcon` variable in this file. Hence fails to reference such a variable, thus a compile time error.")
