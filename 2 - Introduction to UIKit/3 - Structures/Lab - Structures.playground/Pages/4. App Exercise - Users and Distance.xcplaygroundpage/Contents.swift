...
var myName = User(name: "Vanshaj Saxena", age: 20 , height: 5.8, weight: 55, activityLevel: 8);
print(myName)
/*:
...
var newDistanceInFeet = Distance(feet: 34)
var newDistanceInMeters = Distance(meters: 1600)
print(newDistanceInFeet.meters)
print(newDistanceInFeet.feet)

print(newDistanceInMeters.meters)
print(newDistanceInMeters.feet)
//:  Now create an instance of `Distance` called `mile`. Use the initializer for meters to set the distance to 1600. Print out the property for feet and verify that it is equal to 5249.344.
var mile = Distance(meters: 1600)
print(mile.feet)
//:  Now create another instance of `Distance` and give it some other distance. Ensure that both properties are set correctly.
var newDistance = Distance(feet: 500)
print(newDistance.feet)
