...
var myRactangle = Rectangle(width: 10, height: 10)
print(myRactangle.area)
/*:
...
struct Height {
    ...
    init(heightInInches: Double) { self.heightInInches = heightInInches
...
var newHeight = Height(heightInInches: 99)
print("The height in centimeters before mutation is: \(newHeight.heightInCentimeters)")
newHeight.heightInInches = 100
print("The height in centimeters after mutation is: \(newHeight.heightInCentimeters)")
/*:
