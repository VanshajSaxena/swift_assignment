...
var favoriteBook = Book(title: "This is a Title", author: "Vanshaj Saxena", pages: 100 , price: 199.00)
print("The books title is \(favoriteBook.title), the author is \(favoriteBook.author), the number of pages are \(favoriteBook.pages) and the price is \(favoriteBook.price)")
/*:
...
var laptopOne = Laptop(screenSize: 15, repairCount: 2, yearPurchased: 2024)
var laptopTwo = Laptop(yearPurchased: 2024)
/*:
...
var someonesHeight1 = Height(heightInInches: 65)
print(someonesHeight1.heightInCentimeters)
print(someonesHeight1.heightInInches)
var someonesHeight2 = Height(heightInCentimeters: 161.1)
print(someonesHeight2.heightInCentimeters)
print(someonesHeight2.heightInInches)
...
var myHeightinCent = Height(heightInCentimeters: 165.1)
var myHeightinInches = Height(heightInInches: 68)
print(myHeightinCent.heightInInches)
