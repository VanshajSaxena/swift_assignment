...
var workoutOne = RunningWorkout(distance: 100, time: 60, elevation: 10)
...
struct Steps {
    var steps: Int {
        willSet {
            // here we use `newValue` which is a special parameter provided by swift specifically for property observers. It represents the new value that the property is about to receive.
            if newValue == goal {
                print("Here you go! Congratulations on reaching your set goal.")
            }
        }
    }
    var goal: Int
...
var running = Steps(steps: 9999, goal: 10000)
running.takeStep()
/*:
