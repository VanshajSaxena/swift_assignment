 ...
 */
var walkingChallenges:[String] = ["Walk a mile today.", "Walk to the shopping mall."]
var runningChallenges:[String] = ["Run for 10 mins.", "Run one mile."]
...
if committedChallenges.isEmpty {
   print("You have not committed to any challenge, please commit to a challenge.")
