...
let oldHR4 = 70
var hrAverage:Int {
    (heartRate! + oldHR4 + oldHR3 + oldHR2 + oldHR1)/5
}
print(hrAverage)
heartRate = nil
if let sensorHR = heartRate {
    var avgHeartRate = (oldHR1 + oldHR2 + oldHR3 + oldHR4 + sensorHR)/5
    print(avgHeartRate)
} else {
    var avgHeartRate = (oldHR1 + oldHR2 + oldHR3 + oldHR4 )/4
    print(avgHeartRate)
}
/*:
