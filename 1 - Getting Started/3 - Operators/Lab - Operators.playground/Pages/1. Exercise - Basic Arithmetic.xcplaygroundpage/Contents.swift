...
print(odd%2)
print(even%2)
print("The modulus or remainder operator can simply be used to check for even odd number check, by dividing the number by 2, remainder equals one will imply an odd number, and a remainder equals 0 will imply a even number")
/*:
